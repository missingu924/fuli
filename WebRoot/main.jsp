...
<frameset rows="72,*,20" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="160,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="<%=request.getContextPath()%>/VillagerWelfareDraw/draw.jsp" name="mainFrame" id="mainFrame" title="mainFrame"  border="0" framespacing="0"/>
  </frameset>
