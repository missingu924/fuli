				...
				<tr class="<%=i % 2 == 0 ? "list_table_tr0" : "list_table_tr1"%>">
					...
					<td width="90" align="center" style="padding: 0; cursor: pointer">
						<img src="../images/list_detail.png" width="25" height="25"
							alt="详情" title="详情"
							onClick="openBigModalDialog('<%=contextPath%>/Auth/Servlet?method=subjectDetail&subjectType=<%=SystemConstant.SUBJECT_TYPE_DEPARTMENT%>&subjectId=<%=o.getDepartmentId()%>')">
