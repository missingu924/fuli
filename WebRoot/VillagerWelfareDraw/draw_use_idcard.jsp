		...
		<div align="center">
			<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center"> 
	          ...
	          <tr>
	            ...
	            <input name="id_card" id="id_card" readonly type="text" class="input_box_id_card" value="<%=StringUtil.getNotEmptyStr(request.getAttribute("id_card")) %>" size="40"/>
	            </td>
	            <td align="center" valign="middle" class="id_card_button" onclick="javascript:ReadIDCard();">
	            读卡查询该村民可领取的福利
	            </td>
	          </tr>
	        </table>
